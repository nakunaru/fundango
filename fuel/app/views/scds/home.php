...
<!--ヘッダー領域-->
    ...
    <div role="main" class="ui-content">
      <ul data-role="listview" data-filter="true" data-filter-placeholder="Search timeline...">
          ...
          {
              echo '<li>'.'<img src="' . $data->user->profile_image_url . '"><div style="text-overflow:ellipsis; overflow:hidden; white-space: nowrap;">' . $data->text . '</div>' . '<p style="text-overflow:ellipsis; overflow:hidden; ">' . $data->user->name . ' @' . $data->user->screen_name .'</p></li>';
          }
          ?>
      </ul>
    </div>
    ...
    <div data-role="panel" id="friendpanel" data-position="right" data-display="overlay">
        ...
        <ul data-role="listview" data-filter="true" data-filter-placeholder="Search friends...">
            ...
            {
                echo '<li class="friendli" screen_name="' . $data->screen_name . '"><a href="#depositAddDialog" data-rel="dialog" data-transition="pop"><div style="text-overflow:ellipsis; overflow:hidden; white-space: nowrap;">' . $data->name . '</div><p style="text-overflow:ellipsis; overflow:hidden; ">' . $data->screen_name . '</p></a></li>';
